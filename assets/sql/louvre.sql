...
CREATE TABLE `book` (
  ...
  CONSTRAINT `CONSTRAINT_3` CHECK (`format` in ('PDF','EPUB','MOBI','AZW3','DVJU'))
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

INSERT INTO `book` (`isbn13`, `title`, `slug`, `price`, `summary`, `ed`, `pages`, `pubdate`, `author`, `lang`, `format`) VALUES
...
CREATE TABLE `bookrecommended` (`isbn13` char(13), `title` varchar(50), `slug` varchar(50), `price` decimal(10,2), `discountedprice` decimal(15,2), `summary` text, `ed` varchar(5), `pages` smallint(6), `pubdate` date, `author` varchar(50), `lang` varchar(12), `format` varchar(5), `genre` mediumtext, `discount` decimal(5,2), `info` text);
