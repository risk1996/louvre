    ...
    <div class="row">
        <div class="col-sm-6">
            <?php form_open('users/register'); ?>
                ...
                <br>
                <h4>Gender</h4>
                <label class="form-check-label"><input class="form-check-input" type="radio" name="gender" value="M" checked><span class="fa fa-mars"></span> Male</label><br>
                <label class="form-check-label"><input class="form-check-input" type="radio" name="gender" value="F"><span class="fa fa-venus"></span> Female</label><br>
                <label class="form-check-label"><input class="form-check-input" type="radio" name="gender" value="O"><span class="fa fa-genderless"></span> Other / Rather not Say</label><br>
                <br>
