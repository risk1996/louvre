        ...
        <div class="col-sm-3">
            ...
            <form action="" method="">
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" aria-describedby="titleaddon" placeholder="Keyword">
                </div>
                <br>
                <div class="input-group">
                    <span class="input-group-addon" id="isbnaddon" style="width: 70px;">ISBN</span>
                    <input type="text" class="form-control" aria-describedby="isbnaddon" placeholder="Keyword">
                </div>
                <br>
                <div class="input-group">
                ...
                <input id="priceslider" data-slider-id="priceslider" type="text" data-slider-ticks="[0, 100, 200, 300, 400]" data-slider-ticks-snap-bounds="30" data-slider-ticks-labels='["$0", "$100", "$200", "$300", "$400"]' data-slider-value="[0,400]" style="width:100%;"/>
                <script>
                ...
                <br>
                <input id="pagesslider" data-slider-id="pagesslider" type="text" data-slider-ticks="[0, 1000, 2000, 3000, 4000, 5000]" data-slider-ticks-snap-bounds="30" data-slider-ticks-labels='["0", "1000", "2000", "3000", "4000", "5000"]' data-slider-value="[0,5000]" style="width:100%;"/>
                <script>
